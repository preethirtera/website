      ...
      <div className="hero-inner">
        ...
        <div className="hero-left" ref={leftRef}>
          ...
          <div className={`hero-actions ${done ? "show" : ""}`}>
            <button className="btn btn-primary" onClick={onGetInTouch}>Get in touch</button>
            <button className="btn btn-secondary" onClick={onViewProjects}>View Projects</button>
          </div>
        </div>
